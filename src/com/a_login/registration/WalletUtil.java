...
public class WalletUtil {
     ...
     */
    public static MaskedWalletRequest createMaskedWalletRequest(Product product) {
     ...
     */
    private static List<LineItem> buildLineItems(Product product, boolean isEstimate) {
        List<LineItem> list = new ArrayList<LineItem>();
        String itemPrice = toDollars(product.getPrice());
        ...
        String shippingPrice = toDollars(
                isEstimate ? product.getEstimatedShippingPriceMicros() : product.getShippingPriceMicros());
        ...
        String tax = toDollars(
                isEstimate ? product.getEstimatedTaxMicros() : product.getTaxMicros());
     ...
     */
    public static FullWalletRequest createFullWalletRequest(Product product,
            String googleTransactionId) {

        List<LineItem> lineItems = buildLineItems(product, false);

 ...
 */
public class ConfirmationFragment extends IWantWalletFragment implements OnClickListener {
    ...
    public View onCreateView(
        ...
        itemName.setText(mCartList.get(0).getTitle());

		Drawable itemImage = new BitmapDrawable(getResources(), mCartList.get(0).getImage());
        ...
        //itemPrice.setText(Util.formatPrice(getActivity(), mCartList.get(0).price));
        itemPrice.setText(String.valueOf((mCartList.get(0).getPrice())));
    ...
    private void updateUiForNewMaskedWallet() {
        ...
        System.out.println("SUD Price >>> "+mCartList.get(0).getShippingPriceMicros());
        /*mShipping.setText(Util.formatPrice(getActivity(), mCartList.get(0).getShippingPriceMicros()));
        mTax.setText(Util.formatPrice(getActivity(), mCartList.get(0).getTaxMicros()));
        mTotal.setText(Util.formatPrice(getActivity(), mCartList.get(0).getTotalPrice()));*/
        mShipping.setText(String.valueOf(mCartList.get(0).getShippingPriceMicros()));
        mTax.setText(String.valueOf(mCartList.get(0).getTaxMicros()));
        mTotal.setText(String.valueOf(mCartList.get(0).getTotalPrice()));
    ...
    private void getFullWallet() {
        mWalletClient.loadFullWallet(WalletUtil.createFullWalletRequest(mCartList.get(0),

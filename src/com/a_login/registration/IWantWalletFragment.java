 ...
 */
public abstract class IWantWalletFragment extends Fragment implements ConnectionCallbacks,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String accountName = ((IWantApplication) getActivity().getApplication()).getAccountName();
    ...
    private static class RetryHandler extends Handler {
        ...
        private WeakReference<IWantWalletFragment> mWeakReference;

        protected RetryHandler(IWantWalletFragment walletFragment) {
            mWeakReference = new WeakReference<IWantWalletFragment>(walletFragment);
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_RETRY_CONNECTION:
                    IWantWalletFragment walletFragment = mWeakReference.get();

 ...
 * {@link IWantWalletFragment}.
 */
public class IWantWalletFragmentActivity extends FragmentActivity {
     ...
     * {@link IWantWalletFragment}. If the requestCode is one of the predefined codes to handle
     * the API calls, pass it to the fragment or else treat it normally.
     */
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case IWantWalletFragment.REQUEST_CODE_RESOLVE_CHANGE_MASKED_WALLET:
            case IWantWalletFragment.REQUEST_CODE_RESOLVE_LOAD_MASKED_WALLET:
            case IWantWalletFragment.REQUEST_CODE_RESOLVE_LOAD_FULL_WALLET:
            case IWantWalletFragment.REQUEST_CODE_RESOLVE_ERR:
